...
pygame.mixer.music.load("assets_nivel1/ASGORE.mp3")
...
class linea_meta(pygame.sprite.Sprite):   
    ...
    def __init__(self, x, y, w=20, h=30):
        ...
        self.surf = pygame.image.load("assets_nivel1/meta.jpg").convert_alpha() #cambiar esta linea de meta
...
class portal_cubo(pygame.sprite.Sprite):   
    def __init__(self, x, y, w=20, h=30):
        ...
        self.surf.fill((120, 120, 120))
        self.rect = self.surf.get_rect(topleft=(x, y))
        self.surf = pygame.image.load("assets_nivel1/portal.png").convert_alpha()#cambiar este portal por el violeta
        self.surf = pygame.transform.scale(self.surf, (w, h))
...
class portal_cohete(pygame.sprite.Sprite):
    def __init__(self, x, y, w, h):
        ...
        self.surf.fill((120, 120, 120))
        self.rect = self.surf.get_rect(topleft=(x, y))
        self.surf = pygame.image.load("assets_nivel1/portal.png").convert_alpha()#assets/img/obstaculos_jugador/portal_cohete.png
        self.surf = pygame.transform.scale(self.surf, (w, h))
...
class Spike(pygame.sprite.Sprite):
    def __init__(self, x, y, w, h, orientacion = 'up'):
        ...
        self.rect = self.surf.get_rect(topleft=(x, y))   
        self.surf = pygame.image.load("assets_nivel1/pinchos.png").convert_alpha()#assets/img/obstaculos_jugador/pincho.png
...
class platform(pygame.sprite.Sprite):
    def __init__(self, x, y, w, h):
        ...
        self.rect = self.surf.get_rect(topleft=(x, y))
        self.surf = pygame.image.load("assets_nivel1/plataforma.jpg").convert_alpha()#assets/img/plataformas_signos/plataforma_final.png
        self.surf = pygame.transform.scale(self.surf, (w, h))
...
#se podria poner ma plataformas
...
class plataformamuro(pygame.sprite.Sprite):
    def __init__(self, x, y, w, h):
        ...
        self.surf.fill((255,0,255))
        self.rect = self.surf.get_rect(topleft=(x, y))
        self.surf = pygame.image.load("assets_nivel1/muro.jpg").convert_alpha()#assets/img/obstaculos_jugador/pared.png
        self.surf = pygame.transform.scale(self.surf, (w, h))
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.original_surf = pygame.image.load("assets_nivel1/skin_geometrydash.jpg").convert_alpha()#assets/img/obstaculos_jugador/cubo_jugador.jpg
    ...
    def update(self):
        ...
        # Se modifican los portales para solo manejar el cohete o el cubo
    ...
    def salto(self):
        if self.saltable:
            self.vel.y=-5
            self.saltable=False
        # elif self.modo_ufo: <-- ¡Lógica de salto UFO eliminada!
        #     self.vel.y=-4.3 <-- ¡Lógica de salto UFO eliminada!
        for orbe in orbes_amarillas:
            if pygame.sprite.spritecollide(self, [orbe], False):
                orbe.usado = True

    def reset(self):
        # Restablece la posición del jugador al inicio del nivel
        self.pos = vec((110, 400))
        # Restablece la velocidad y aceleración
        self.vel = vec(0,0)
        self.acc = vec(0,0)
        # Restablece los estados del jugador
        self.saltable = False
        self.modo_cohete = False
